...
if ! [[ $(grep "$PS0" ~/.bashrc) ]]; then
    echo -e "\n$PS0" >> ~/.bashrc
    echo -e "\033[01;32m"\'$(grep "$PS0" ~/.bashrc)\' added to ~/.bashrc "\033[0m"
else
    echo -e "\033[00;33m'$PS0' is already set in ~/.bashrc \033[0m"
fi
